...
export function TerminalDemo() {
  return (
    <Terminal
      title="fx402"
      className="max-h-none w-full max-w-none rounded-lg"
    >
      <TypingAnimation duration={12} className={dim}>
        {"𝒇x402 v0.0.5 · Run /help for commands"}
      </TypingAnimation>
      ...
      <AnimatedSpan className="text-green-500/90">
