...
export const Terminal = ({
  ...
  const content = (
    ...
    >
      <div className="border-border relative flex items-center border-b px-4 py-3">
        ...
        {title ? (
          <span className="text-muted-foreground pointer-events-none absolute inset-x-0 text-center text-sm">
            {title}
          </span>
        ) : null}
      </div>
